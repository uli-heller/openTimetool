 ...
 * $Id
 * 
 * It is so hard to debug that stuff, that we create a logging utility which can be included in any 
 * script
 * 
 ...
 * 
 * I have stolen that piece of code from classes/common.oho and modified it a bit to be more
 * flexible useable
 * 
...
class logging {
    ...
    */
    ...
    function _logme( $section, $msg,$method=0,$line=0)
    {
        ...
        $this->_log->log('['.$section.($method?"::$method":'')."] $msg".($line?" ($line)":''));
    }  
}  
