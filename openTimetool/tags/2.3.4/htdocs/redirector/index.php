...
//
//  $Log: index.php,v $
//  Revision 1.1  2003/01/28 10:58:56  wk
//  - simple redirect for asp-version online
//
//
...
$url = $config->vServerRoot.'/'.$session->account->ttVersion.str_replace("__{$session->accountName}",'',$_SERVER['PHP_SELF']);
*/
...
$url = $config->vServerRoot.'/__'.$_SERVER['VPCUST'].'/1.0.4/'.str_replace("/__{$_SERVER['VPCUST']}/",'',$_SERVER['PHP_SELF']);
